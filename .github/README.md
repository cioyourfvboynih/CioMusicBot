<img src="https://telegra.ph/file/81858c3a4428f97fec321.jpg" align="right" width="200" height="200"/>

# Cio Music Bot <img src="https://img.shields.io/github/v/release/cioyourfvboynih/CioMusicBot?color=black&logo=github&logoColor=black&style=social" alt="RELEASE">

[Cio Music Bot](https://github.com/cioyourfvboynih/CioMusicBot) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
* For database, Cio uses the MongoDB to store data and keys. [MongoDB](https://www.mongodb.com/) is a document database with the scalability and flexibility that you want with the querying and indexing that you need.
...
> If you want to start working with Cio Music Bot you can either fork or import repo .
